...
class NonSmoothNewtonEngine:
    ...
    def _compute_attributes(self, state_in: State, control: Control, dt: float) -> None:
        ...
        self._contact_mask_n = state_in.contact_mask_per_body.clone()  # [B, C]
        self._contact_mask_t = state_in.contact_mask_per_body_friction.clone() # [B, C]
        ...
        self._J_t = self.friction_constraint.compute_tangential_jacobians(
            state_in.body_q,
            state_in.contact_points_per_body_friction,
            state_in.contact_normals_per_body_friction,
            state_in.contact_mask_per_body_friction,
        )  # [B, 2C, 6]
