...
OUTPUT_FILE = os.path.join(project_dir, "simulation", "helhest_terrain_climb_mesh.json")
...
def main():
    ...
    if ENGINE == "XPBD":
        ...
        engine = NonSmoothNewtonEngine(model, iterations=150, device=device)
    else:
